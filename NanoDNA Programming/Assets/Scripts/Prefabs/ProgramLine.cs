...
public class ProgramLine : MonoBehaviour
{
    ...
    public IEnumerator delLineAnim ()
    {
        ...
        yield return StartCoroutine(DNAMathAnim.animateCosinusoidalRelocationLocal(ProgramUI.UI.GetChild(0), new Vector3(-1f * ProgramUI.UI.GetChild(0).GetComponent<RectTransform>().sizeDelta.x, 0, 0), DNAMathAnim.getFrameNumber(1f), 0, true));
