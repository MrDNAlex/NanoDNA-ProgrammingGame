...
public class MathValueValController : ValueValController
{
    ...
    //Switch this to apply for a math operation switch
    ...
    public void setPanel(Transform parent, MathOperations operationCard)
    {
        ...
        this.panelInfo = operationCard.panelInfo;
        this.operationInfo = operationCard.operationInfo;
        ...
        varType = operationCard.panelInfo.varType;
    ...
    void setUI()
    {
        ...
        vars = Camera.main.GetComponent<ProgramManager>().getVariables(operationInfo.varType);
        ...
        foreach (VariableData varData in vars)
        {
            ...
            if (display)
            {
                ...
                variable.GetComponent<Button>().onClick.AddListener(delegate
                {
                    ...
                    //Determine which number we are editing and switch it
